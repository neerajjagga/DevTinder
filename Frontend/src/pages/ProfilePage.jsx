...
const ProfilePage = () => {
    ...
    return (
        <div className="flex justify-center">
            {user ? (
                <div className="flex flex-col gap-4 items-center mt-8 bg-gray-800 py-5 px-10 mx-8 lg:w-1/2 rounded-lg">
                    ...
                    <div className="flex gap-2">
                        {user?.about && (
                            <span className="text-xl -mt-2 text-gray-400">{user.about}</span>
                        )}
                    </div>
